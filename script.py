...
f = pd.ExcelFile('/Users/utkarsh/Documents/study material/computer/sem 5/machine_learning_vit/ml_project/documentation/CAPSULE_TEXT_Translation.xlsx')
...
todo = {
     '../dataset/coupon_area_test.csv'         :['SMALL_AREA_NAME','PREF_NAME'],
     '../dataset/coupon_area_train.csv'        :['SMALL_AREA_NAME','PREF_NAME'],
     '../dataset/coupon_detail_train.csv'      :['SMALL_AREA_NAME'],
     '../dataset/coupon_list_test.csv'         :['CAPSULE_TEXT','GENRE_NAME','ken_name','large_area_name','small_area_name'],
     '../dataset/coupon_list_train.csv'        :['CAPSULE_TEXT','GENRE_NAME','ken_name','large_area_name','small_area_name'],
     # '../input/coupon_visit_train.csv'       :[],
     '../dataset/user_list.csv'                :['PREF_NAME'],
}
