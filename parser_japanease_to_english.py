...
path = '/Users/utkarsh/Documents/study material/computer/sem 5/machine_learning_vit/ml_project/' # Enter the path to home folder containing the input files.
df = pd.read_excel(path + 'documentation/CAPSULE_TEXT.xlsx')

japanese = np.array(df.iloc[0:len(df),1])
print(japanese[0]) 

#for i in range(0,len(df)):
#	if japanese[i] in list(conversion_table.values()):
#		print(conversion_table[japanese[i]])
